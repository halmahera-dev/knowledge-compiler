...
Open [http://localhost:5173](http://localhost:5173) in your browser to see the web application. Auth is served by the same app, at `/api/auth`.
...
kc/
├── apps/
│   └── web/         # Frontend application (React + TanStack Start), incl. auth
├── packages/
